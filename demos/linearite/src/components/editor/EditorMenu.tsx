  ...
  return (
    <div className="bg-white flex shadow-md rounded border p-1">
      <button
        ...
        className={classNames('me-1 px-1 rounded color text-gray-500 hover:text-black', {
      ...
      <button
        ...
        className={classNames('me-1 px-1 py-1 rounded color text-gray-500 hover:text-black', {
      ...
      <button
        ...
        className={classNames('px-1 py-1 rounded color text-gray-500 hover:text-black', {
